...
# [inline (always)]
pub fn set_mco (& mut self , val : super :: vals :: Mco) { self . 0 = (self . 0 & ! (0x0f << 24usize)) | (((val . to_bits () as u32) & 0x0f) << 24usize) ; } # [doc = "ADC clock ADJ."]
# [inline (always)]
...
fn from (val : Adcpre) -> u8 { Adcpre :: to_bits (val) } } # [doc = "AHB prescaler."]
# [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
...
# [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum PllMul { # [doc = "PLL input clock x 18."]
MUL18 = 0x0 , # [doc = "PLL input clock x 3."]
...
MUL14 = 0x0c , # [doc = "PLL input clock x 6.5."]
MUL6_5 = 0x0d , # [doc = "PLL input clock x 15."]
MUL15 = 0x0e , # [doc = "PLL input clock x 16."]
MUL16 = 0x0f , } impl PllMul { # [inline (always)]
