...
# [inline (always)]
pub fn set_tsts (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 29usize)) | (((val as u32) & 0x01) << 29usize) ; } # [doc = "10M PHY physical layer variation"]
# [inline (always)]
pub const fn ipls (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "10M PHY physical layer variation"]
# [inline (always)]
...
# [inline (always)]
pub fn set_rod (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize) ; } # [doc = "Fast Ethernet speed (1 = 100 Mbps, 0 = 10 Mbps)"]
# [inline (always)]
pub const fn fes (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "Fast Ethernet speed (1 = 100 Mbps, 0 = 10 Mbps)"]
# [inline (always)]
pub fn set_fes (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } # [doc = "Carrier sense disable"]
# [inline (always)]
