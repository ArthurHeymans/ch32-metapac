...
# [inline (always)]
pub const fn macpmtcsr (self) -> crate :: common :: Reg < regs :: Macpmtcsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x2cusize) as _) } } # [doc = "Ethernet MAC interrupt status register"]
# [inline (always)]
...
# [inline (always)]
pub const fn maca0lr (self) -> crate :: common :: Reg < regs :: Maca0lr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x44usize) as _) } } # [doc = "Ethernet MAC address 1 high register"]
# [inline (always)]
pub const fn maca1hr (self) -> crate :: common :: Reg < regs :: Maca1hr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x48usize) as _) } } # [doc = "Ethernet MAC address 1 low register"]
# [inline (always)]
pub const fn maca1lr (self) -> crate :: common :: Reg < regs :: Maca1lr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x4cusize) as _) } } # [doc = "Ethernet MAC address 2 high register"]
# [inline (always)]
pub const fn maca2hr (self) -> crate :: common :: Reg < regs :: Maca2hr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x50usize) as _) } } # [doc = "Ethernet MAC address 2 low register"]
# [inline (always)]
pub const fn maca2lr (self) -> crate :: common :: Reg < regs :: Maca2lr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x54usize) as _) } } # [doc = "Ethernet MAC address 3 high register"]
# [inline (always)]
pub const fn maca3hr (self) -> crate :: common :: Reg < regs :: Maca3hr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x58usize) as _) } } # [doc = "Ethernet MAC address 3 low register"]
# [inline (always)]
pub const fn maca3lr (self) -> crate :: common :: Reg < regs :: Maca3lr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x5cusize) as _) } } # [doc = "Ethernet DMA bus mode register"]
# [inline (always)]
pub const fn dmabmr (self) -> crate :: common :: Reg < regs :: Dmabmr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1000usize) as _) } } # [doc = "Ethernet DMA transmit poll demand register"]
# [inline (always)]
pub const fn dmatpdr (self) -> crate :: common :: Reg < regs :: Dmatpdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1004usize) as _) } } # [doc = "Ethernet DMA receive poll demand register"]
# [inline (always)]
pub const fn dmarpdr (self) -> crate :: common :: Reg < regs :: Dmarpdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1008usize) as _) } } # [doc = "Ethernet DMA receive descriptor list address register"]
# [inline (always)]
pub const fn dmardlar (self) -> crate :: common :: Reg < regs :: Dmardlar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x100cusize) as _) } } # [doc = "Ethernet DMA transmit descriptor list address register"]
# [inline (always)]
pub const fn dmatdlar (self) -> crate :: common :: Reg < regs :: Dmatdlar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1010usize) as _) } } # [doc = "Ethernet DMA status register"]
# [inline (always)]
pub const fn dmasr (self) -> crate :: common :: Reg < regs :: Dmasr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1014usize) as _) } } # [doc = "Ethernet DMA operation mode register"]
# [inline (always)]
pub const fn dmaomr (self) -> crate :: common :: Reg < regs :: Dmaomr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1018usize) as _) } } # [doc = "Ethernet DMA interrupt enable register"]
# [inline (always)]
pub const fn dmaier (self) -> crate :: common :: Reg < regs :: Dmaier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x101cusize) as _) } } # [doc = "Ethernet DMA missed frame and buffer overflow counter register"]
# [inline (always)]
pub const fn dmamfbocr (self) -> crate :: common :: Reg < regs :: Dmamfbocr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1020usize) as _) } } # [doc = "Ethernet DMA current host transmit descriptor register"]
# [inline (always)]
pub const fn dmachtdr (self) -> crate :: common :: Reg < regs :: Dmachtdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1048usize) as _) } } # [doc = "Ethernet DMA current host receive descriptor register"]
# [inline (always)]
pub const fn dmachrdr (self) -> crate :: common :: Reg < regs :: Dmachrdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x104cusize) as _) } } # [doc = "Ethernet DMA current host transmit buffer address register"]
# [inline (always)]
pub const fn dmachtbar (self) -> crate :: common :: Reg < regs :: Dmachtbar , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1050usize) as _) } } # [doc = "Ethernet DMA current host receive buffer address register"]
# [inline (always)]
pub const fn dmachrbar (self) -> crate :: common :: Reg < regs :: Dmachrbar , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1054usize) as _) } } } pub mod regs { # [doc = "Ethernet DMA bus mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_nise (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize) ; } # [doc = "10M PHY link status change interrupt enable"]
# [inline (always)]
pub const fn iple (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "10M PHY link status change interrupt enable"]
# [inline (always)]
...
# [inline (always)]
pub const fn sr (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "Start/stop receive"]
# [inline (always)]
pub fn set_sr (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Operate on second frame"]
# [inline (always)]
...
# [inline (always)]
pub const fn rtc (& self) -> u8 { let val = (self . 0 >> 3usize) & 0x03 ; val as u8 } # [doc = "Receive threshold control"]
# [inline (always)]
pub fn set_rtc (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 3usize)) | (((val as u32) & 0x03) << 3usize) ; } # [doc = "Forward undersized good frames"]
# [inline (always)]
pub const fn fugf (& self) -> bool { let val = (self . 0 >> 6usize) & 0x01 ; val != 0 } # [doc = "Forward undersized good frames"]
# [inline (always)]
pub fn set_fugf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize) ; } # [doc = "Forward error frames"]
# [inline (always)]
pub const fn fef (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Forward error frames"]
# [inline (always)]
pub fn set_fef (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Start/stop transmission"]
# [inline (always)]
pub const fn st (& self) -> bool { let val = (self . 0 >> 13usize) & 0x01 ; val != 0 } # [doc = "Start/stop transmission"]
# [inline (always)]
pub fn set_st (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize) ; } # [doc = "Transmit threshold control"]
# [inline (always)]
pub const fn ttc (& self) -> u8 { let val = (self . 0 >> 14usize) & 0x07 ; val as u8 } # [doc = "Transmit threshold control"]
# [inline (always)]
pub fn set_ttc (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 14usize)) | (((val as u32) & 0x07) << 14usize) ; } # [doc = "Flush transmit FIFO"]
# [inline (always)]
...
# [inline (always)]
pub const fn tsf (& self) -> bool { let val = (self . 0 >> 21usize) & 0x01 ; val != 0 } # [doc = "Transmit store and forward"]
# [inline (always)]
pub fn set_tsf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize) ; } # [doc = "Disable flushing of received frames"]
# [inline (always)]
...
# [inline (always)]
pub const fn rsf (& self) -> bool { let val = (self . 0 >> 25usize) & 0x01 ; val != 0 } # [doc = "Receive store and forward"]
# [inline (always)]
pub fn set_rsf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize) ; } # [doc = "Dropping of TCP/IP checksum error frames disable"]
# [inline (always)]
pub const fn dtcefd (& self) -> bool { let val = (self . 0 >> 26usize) & 0x01 ; val != 0 } # [doc = "Dropping of TCP/IP checksum error frames disable"]
# [inline (always)]
...
fn default () -> Dmardlar { Dmardlar (0) } } # [doc = "Ethernet DMA receive poll demand register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn rwts (& self) -> bool { let val = (self . 0 >> 9usize) & 0x01 ; val != 0 } # [doc = "Receive watchdog timeout status"]
# [inline (always)]
pub fn set_rwts (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize) ; } # [doc = "Early transmit status"]
# [inline (always)]
...
# [inline (always)]
pub fn set_tsts (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 29usize)) | (((val as u32) & 0x01) << 29usize) ; } # [doc = "10M PHY physical layer status (write 1 to clear)"]
# [inline (always)]
pub const fn ipls (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "10M PHY physical layer status (write 1 to clear)"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca0lr (pub u32) ; impl Maca0lr { # [doc = "MAC address0 low"]
# [inline (always)]
pub const fn maca0l (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "MAC address0 low"]
# [inline (always)]
...
fn default () -> Maca0lr { Maca0lr (0) } } # [doc = "Ethernet MAC address 1 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca1hr (pub u32) ; impl Maca1hr { # [doc = "MAC address1 high"]
# [inline (always)]
pub const fn maca1h (& self) -> u16 { let val = (self . 0 >> 0usize) & 0xffff ; val as u16 } # [doc = "MAC address1 high"]
# [inline (always)]
pub fn set_maca1h (& mut self , val : u16) { self . 0 = (self . 0 & ! (0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize) ; } # [doc = "Mask byte control"]
# [inline (always)]
...
# [inline (always)]
pub fn set_ae (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize) ; } } impl Default for Maca1hr { # [inline (always)]
fn default () -> Maca1hr { Maca1hr (0) } } # [doc = "Ethernet MAC address 1 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca1lr (pub u32) ; impl Maca1lr { # [doc = "MAC address1 low"]
# [inline (always)]
pub const fn maca1l (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "MAC address1 low"]
# [inline (always)]
pub fn set_maca1l (& mut self , val : u32) { self . 0 = (self . 0 & ! (0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize) ; } } impl Default for Maca1lr { # [inline (always)]
fn default () -> Maca1lr { Maca1lr (0) } } # [doc = "Ethernet MAC address 2 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca2hr (pub u32) ; impl Maca2hr { # [doc = "MAC address2 high"]
# [inline (always)]
pub const fn maca2h (& self) -> u16 { let val = (self . 0 >> 0usize) & 0xffff ; val as u16 } # [doc = "MAC address2 high"]
# [inline (always)]
pub fn set_maca2h (& mut self , val : u16) { self . 0 = (self . 0 & ! (0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize) ; } # [doc = "Mask byte control"]
# [inline (always)]
pub const fn mbc (& self) -> u8 { let val = (self . 0 >> 24usize) & 0x3f ; val as u8 } # [doc = "Mask byte control"]
# [inline (always)]
pub fn set_mbc (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x3f << 24usize)) | (((val as u32) & 0x3f) << 24usize) ; } # [doc = "Source address"]
...
pub const fn ae (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "Address enable"]
# [inline (always)]
pub fn set_ae (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize) ; } } impl Default for Maca2hr { # [inline (always)]
fn default () -> Maca2hr { Maca2hr (0) } } # [doc = "Ethernet MAC address 2 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca2lr (pub u32) ; impl Maca2lr { # [doc = "MAC address2 low"]
# [inline (always)]
pub const fn maca2l (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "MAC address2 low"]
# [inline (always)]
pub fn set_maca2l (& mut self , val : u32) { self . 0 = (self . 0 & ! (0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize) ; } } impl Default for Maca2lr { # [inline (always)]
fn default () -> Maca2lr { Maca2lr (0) } } # [doc = "Ethernet MAC address 3 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca3hr (pub u32) ; impl Maca3hr { # [doc = "MAC address3 high"]
# [inline (always)]
pub const fn maca3h (& self) -> u16 { let val = (self . 0 >> 0usize) & 0xffff ; val as u16 } # [doc = "MAC address3 high"]
# [inline (always)]
pub fn set_maca3h (& mut self , val : u16) { self . 0 = (self . 0 & ! (0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize) ; } # [doc = "Mask byte control"]
# [inline (always)]
pub const fn mbc (& self) -> u8 { let val = (self . 0 >> 24usize) & 0x3f ; val as u8 } # [doc = "Mask byte control"]
# [inline (always)]
pub fn set_mbc (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x3f << 24usize)) | (((val as u32) & 0x3f) << 24usize) ; } # [doc = "Source address"]
...
pub const fn ae (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "Address enable"]
# [inline (always)]
pub fn set_ae (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize) ; } } impl Default for Maca3hr { # [inline (always)]
fn default () -> Maca3hr { Maca3hr (0) } } # [doc = "Ethernet MAC address 3 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maca3lr (pub u32) ; impl Maca3lr { # [doc = "MAC address3 low"]
# [inline (always)]
pub const fn maca3l (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "MAC address3 low"]
# [inline (always)]
pub fn set_maca3l (& mut self , val : u32) { self . 0 = (self . 0 & ! (0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize) ; } } impl Default for Maca3lr { # [inline (always)]
fn default () -> Maca3lr { Maca3lr (0) } } # [doc = "Ethernet MAC configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Maccr (pub u32) ; impl Maccr { # [doc = "Send clock selection bit (10M PHY)"]
# [inline (always)]
pub const fn tces (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Send clock selection bit (10M PHY)"]
# [inline (always)]
pub fn set_tces (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Send clock reversal (10M PHY)"]
# [inline (always)]
pub const fn tcf (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "Send clock reversal (10M PHY)"]
# [inline (always)]
pub fn set_tcf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Receiver enable"]
# [inline (always)]
...
# [inline (always)]
pub fn set_bl (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 5usize)) | (((val as u32) & 0x03) << 5usize) ; } # [doc = "Automatic pad/CRC stripping"]
# [inline (always)]
pub const fn apcs (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Automatic pad/CRC stripping"]
# [inline (always)]
pub fn set_apcs (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Retry disable"]
# [inline (always)]
pub const fn rd (& self) -> bool { let val = (self . 0 >> 9usize) & 0x01 ; val != 0 } # [doc = "Retry disable"]
# [inline (always)]
pub fn set_rd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize) ; } # [doc = "IPv4 checksum offload"]
# [inline (always)]
pub const fn ipco (& self) -> bool { let val = (self . 0 >> 10usize) & 0x01 ; val != 0 } # [doc = "IPv4 checksum offload"]
# [inline (always)]
pub fn set_ipco (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize) ; } # [doc = "Duplex mode"]
# [inline (always)]
pub const fn dm (& self) -> bool { let val = (self . 0 >> 11usize) & 0x01 ; val != 0 } # [doc = "Duplex mode"]
# [inline (always)]
pub fn set_dm (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } # [doc = "Loopback mode"]
# [inline (always)]
pub const fn lm (& self) -> bool { let val = (self . 0 >> 12usize) & 0x01 ; val != 0 } # [doc = "Loopback mode"]
# [inline (always)]
pub fn set_lm (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } # [doc = "Receive own disable"]
# [inline (always)]
pub const fn rod (& self) -> bool { let val = (self . 0 >> 13usize) & 0x01 ; val != 0 } # [doc = "Receive own disable"]
# [inline (always)]
pub fn set_rod (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize) ; } # [doc = "Ethernet speed: 00=10M, 01=100M, 10=1G, 11=reserved"]
# [inline (always)]
pub const fn fes (& self) -> u8 { let val = (self . 0 >> 14usize) & 0x03 ; val as u8 } # [doc = "Ethernet speed: 00=10M, 01=100M, 10=1G, 11=reserved"]
# [inline (always)]
pub fn set_fes (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 14usize)) | (((val as u32) & 0x03) << 14usize) ; } # [doc = "Carrier sense disable"]
# [inline (always)]
pub const fn csd (& self) -> bool { let val = (self . 0 >> 16usize) & 0x01 ; val != 0 } # [doc = "Carrier sense disable"]
# [inline (always)]
pub fn set_csd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize) ; } # [doc = "Interframe gap"]
# [inline (always)]
pub const fn ifg (& self) -> u8 { let val = (self . 0 >> 17usize) & 0x07 ; val as u8 } # [doc = "Interframe gap"]
# [inline (always)]
pub fn set_ifg (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 17usize)) | (((val as u32) & 0x07) << 17usize) ; } # [doc = "10M PHY 50 ohm set"]
# [inline (always)]
pub const fn ire (& self) -> bool { let val = (self . 0 >> 20usize) & 0x01 ; val != 0 } # [doc = "10M PHY 50 ohm set"]
# [inline (always)]
pub fn set_ire (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize) ; } # [doc = "10M PHY TX driver bias current"]
# [inline (always)]
pub const fn pdi (& self) -> bool { let val = (self . 0 >> 21usize) & 0x01 ; val != 0 } # [doc = "10M PHY TX driver bias current"]
# [inline (always)]
pub fn set_pdi (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize) ; } # [doc = "Jabber disable"]
# [inline (always)]
pub const fn jd (& self) -> bool { let val = (self . 0 >> 22usize) & 0x01 ; val != 0 } # [doc = "Jabber disable"]
# [inline (always)]
pub fn set_jd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize) ; } # [doc = "Watchdog disable"]
# [inline (always)]
pub const fn wd (& self) -> bool { let val = (self . 0 >> 23usize) & 0x01 ; val != 0 } # [doc = "Watchdog disable"]
# [inline (always)]
pub fn set_wd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize) ; } # [doc = "Send clock delay (10M PHY)"]
# [inline (always)]
pub const fn tcd (& self) -> u8 { let val = (self . 0 >> 29usize) & 0x07 ; val as u8 } # [doc = "Send clock delay (10M PHY)"]
# [inline (always)]
pub fn set_tcd (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 29usize)) | (((val as u32) & 0x07) << 29usize) ; } } impl Default for Maccr { # [inline (always)]
fn default () -> Maccr { Maccr (0) } } # [doc = "Ethernet MAC flow control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Macfcr (pub u32) ; impl Macfcr { # [doc = "Flow control busy/back pressure activate"]
# [inline (always)]
pub const fn fcb_bpa (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Flow control busy/back pressure activate"]
# [inline (always)]
...
# [inline (always)]
pub const fn plt (& self) -> u8 { let val = (self . 0 >> 4usize) & 0x03 ; val as u8 } # [doc = "Pause low threshold"]
# [inline (always)]
pub fn set_plt (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 4usize)) | (((val as u32) & 0x03) << 4usize) ; } # [doc = "Zero-quanta pause disable"]
# [inline (always)]
pub const fn zqpd (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Zero-quanta pause disable"]
# [inline (always)]
pub fn set_zqpd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Pause time"]
# [inline (always)]
...
# [inline (always)]
pub const fn hu (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "Hash unicast"]
# [inline (always)]
pub fn set_hu (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Hash multicast"]
# [inline (always)]
pub const fn hm (& self) -> bool { let val = (self . 0 >> 2usize) & 0x01 ; val != 0 } # [doc = "Hash multicast"]
# [inline (always)]
pub fn set_hm (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Destination address inverse filtering"]
# [inline (always)]
pub const fn daif (& self) -> bool { let val = (self . 0 >> 3usize) & 0x01 ; val != 0 } # [doc = "Destination address inverse filtering"]
# [inline (always)]
...
# [inline (always)]
pub const fn bfd (& self) -> bool { let val = (self . 0 >> 5usize) & 0x01 ; val != 0 } # [doc = "Broadcast frames disable"]
# [inline (always)]
pub fn set_bfd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize) ; } # [doc = "Pass control frames"]
# [inline (always)]
pub const fn pcf (& self) -> u8 { let val = (self . 0 >> 6usize) & 0x03 ; val as u8 } # [doc = "Pass control frames"]
# [inline (always)]
pub fn set_pcf (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 6usize)) | (((val as u32) & 0x03) << 6usize) ; } # [doc = "Source address inverse filtering"]
# [inline (always)]
pub const fn saif (& self) -> bool { let val = (self . 0 >> 8usize) & 0x01 ; val != 0 } # [doc = "Source address inverse filtering"]
# [inline (always)]
pub fn set_saif (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize) ; } # [doc = "Source address filter"]
# [inline (always)]
pub const fn saf (& self) -> bool { let val = (self . 0 >> 9usize) & 0x01 ; val != 0 } # [doc = "Source address filter"]
# [inline (always)]
...
# [inline (always)]
pub fn set_hpf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize) ; } # [doc = "Receive all"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Machthr (pub u32) ; impl Machthr { # [doc = "Hash table high"]
# [inline (always)]
pub const fn hth (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "Hash table high"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Machtlr (pub u32) ; impl Machtlr { # [doc = "Hash table low"]
# [inline (always)]
pub const fn htl (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "Hash table low"]
# [inline (always)]
...
# [inline (always)]
pub const fn pmtim (& self) -> bool { let val = (self . 0 >> 3usize) & 0x01 ; val != 0 } # [doc = "PMT interrupt mask"]
# [inline (always)]
pub fn set_pmtim (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize) ; } # [doc = "Time stamp trigger interrupt mask"]
# [inline (always)]
pub const fn tstim (& self) -> bool { let val = (self . 0 >> 9usize) & 0x01 ; val != 0 } # [doc = "Time stamp trigger interrupt mask"]
# [inline (always)]
pub fn set_tstim (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize) ; } } impl Default for Macimr { # [inline (always)]
...
# [inline (always)]
pub fn set_mb (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "MII write"]
# [inline (always)]
pub const fn mw (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "MII write"]
# [inline (always)]
pub fn set_mw (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Clock range"]
# [inline (always)]
pub const fn cr (& self) -> u8 { let val = (self . 0 >> 2usize) & 0x07 ; val as u8 } # [doc = "Clock range"]
# [inline (always)]
pub fn set_cr (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 2usize)) | (((val as u32) & 0x07) << 2usize) ; } # [doc = "MII register"]
# [inline (always)]
pub const fn mr (& self) -> u8 { let val = (self . 0 >> 6usize) & 0x1f ; val as u8 } # [doc = "MII register"]
# [inline (always)]
pub fn set_mr (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x1f << 6usize)) | (((val as u32) & 0x1f) << 6usize) ; } # [doc = "PHY address"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Macmiidr (pub u32) ; impl Macmiidr { # [doc = "MII data"]
# [inline (always)]
...
# [inline (always)]
pub const fn pd (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Power down"]
# [inline (always)]
pub fn set_pd (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Magic packet enable"]
# [inline (always)]
...
# [inline (always)]
pub const fn wffrpr (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "Wakeup frame filter register pointer reset"]
# [inline (always)]
pub fn set_wffrpr (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize) ; } } impl Default for Macpmtcsr { # [inline (always)]
...
# [inline (always)]
pub const fn vlantc (& self) -> bool { let val = (self . 0 >> 16usize) & 0x01 ; val != 0 } # [doc = "12-bit VLAN tag comparison"]
# [inline (always)]
pub fn set_vlantc (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize) ; } } impl Default for Macvlantr { # [inline (always)]
fn default () -> Macvlantr { Macvlantr (0) } } }