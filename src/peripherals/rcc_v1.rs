...
# [inline (always)]
pub fn set_crcen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize) ; } # [doc = "USBHD clock enable."]
# [inline (always)]
pub const fn usbhden (& self) -> bool { let val = (self . 0 >> 12usize) & 0x01 ; val != 0 } # [doc = "USBHD clock enable."]
# [inline (always)]
pub fn set_usbhden (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } } impl Default for Ahbpcenr { # [inline (always)]
...
# [inline (always)]
pub const fn usbhdrst (& self) -> bool { let val = (self . 0 >> 12usize) & 0x01 ; val != 0 } # [doc = "USBHD reset."]
# [inline (always)]
pub fn set_usbhdrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } } impl Default for Ahbrstr { # [inline (always)]
...
# [inline (always)]
pub fn set_usbden (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize) ; } # [doc = "CAN clock enable."]
# [inline (always)]
...
# [inline (always)]
pub fn set_usbdrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize) ; } # [doc = "CAN reset."]
# [inline (always)]
...
# [inline (always)]
pub fn set_iopdrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize) ; } # [doc = "ADC interface reset."]
# [inline (always)]
...
# [inline (always)]
pub const fn mco (& self) -> u8 { let val = (self . 0 >> 24usize) & 0x07 ; val as u8 } # [doc = "Microcontroller clock output."]
# [inline (always)]
pub fn set_mco (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 24usize)) | (((val as u32) & 0x07) << 24usize) ; } } impl Default for Cfgr0 { # [inline (always)]
...
fn from (val : Hpre) -> u8 { Hpre :: to_bits (val) } } # [doc = "PLLMUL configuration. max 72MHz"]
# [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
...
MUL16 = 0x0e , # [doc = "PLL input clock x 16."]
MUL16_ALT = 0x0f , } impl PllMul { # [inline (always)]
...
# [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Usbpre { # [doc = "PLL clock divided by 1.5(PLLCLK=72MHz)."]
DIV1_5 = 0x0 , # [doc = "PLL clock divided by 1(PLLCLK=48MHz)."]
