        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rtx_bit0",
                    description: Some(
                        "Value of RX/TX shift register, bit 0.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pa_cc_ai",
                    description: Some(
                        "CC port comparator analog input.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
