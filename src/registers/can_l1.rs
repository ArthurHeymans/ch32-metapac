        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "fr",
                    description: Some(
                        "Filter bank 0 register 1. F0R1 to F12R2",
                    ),
                    array: Some(
                        Array::Regular(
                            RegularArray {
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sjw_fd",
                    description: Some(
                        "Resynchronization width setting.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "brp_fd",
                    description: Some(
                        "Minimum time length setting value.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "tdce",
                    description: Some(
                        "FD Frame sending delay compensation enable.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tdcv",
                    description: Some(
                        "FD Send delay compensation value.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "timcmv",
                    description: Some(
                        "Internal counter count end value.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
