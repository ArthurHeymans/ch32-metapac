        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "addr",
                    description: Some(
                        "DMA buffer address of USB endpoint X.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tx_len",
                    description: Some(
                        "transmit length of USB endpoint X. The length varies with the endpoint type.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "setup_ack",
                    description: Some(
                        "RO, indicate setup packet received.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
