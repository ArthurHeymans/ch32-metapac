    ...
    blocks: &[
        Block {
            ...
            extends: None,
            description: Some(
                "Universal serial bus FS register",
            ),
            items: &[
                BlockItem {
                    name: "ctrl",
        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "uepx_mod",
                    description: Some(
                        "UEP endpoint X mode control register.",
                    ),
                    array: None,
                    byte_offset: 0x70,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "t_en",
                    description: Some(
                        "enable USB endpoint (8-15) transmittal (IN).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "r_en",
                    description: Some(
                        "enable USB endpoint (8-15) receiving (OUT).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "t_af",
                    description: Some(
                        "enable USB endpoint (8-15) transmittal alternate function.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
