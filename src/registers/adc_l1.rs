    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "adc_buftrim",
                    description: Some(
                        "ADC buffer misalignment control.",
                    ),
                ...
                Field {
                    name: "tkey_drv_outen",
                    description: Some(
                        "TOUCHKEY shielded each channel enable.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
        ...
        FieldSet {
            ...
            extends: None,
            description: Some(
                "sample time register 1. Only ch 18, 17, 16 are available.",
            ),
            bit_size: 32,
            fields: &[
                Field {
    ...
    enums: &[
        ...
        Enum {
            name: "SampleTime",
            description: Some(
                "Sample time selection, when ADC_LP=0",
            ),
            bit_size: 3,
            variants: &[
                EnumVariant {
