        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "hsirdy",
                    description: Some(
                        "HSI Internal High Speed clock ready flag.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "HSI",
                    description: Some(
                        "HSI or HSI/2 selected as PLL input clock.",
                    ),
                    value: 0,
                },
                EnumVariant {
                    name: "HSE",
                    description: Some(
                        "HSE or HSE/2 selected as PLL input clock.",
                    ),
                    value: 1,
                },
            ],
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "DIV1_5",
                    description: Some(
                        "PLL clock divided by 1.5(PLLCLK=72MHz).",
                    ),
                    value: 2,
                },
            ],
